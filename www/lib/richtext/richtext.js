...
function writeDefault(rte, html, width, height, buttons, readOnly) {
	if (!readOnly) {
		document.writeln('<textarea class="text_field" name="' + rte + '" id="' + rte + '" style="width: ' + width + 'px; height: ' + height + 'px;">' + html + '</textarea>');
	} else {
		document.writeln('<textarea class="text_field" name="' + rte + '" id="' + rte + '" style="width: ' + width + 'px; height: ' + height + 'px;" readonly>' + html + '</textarea>');
	}
}
...
function writeRTE(rte, html, width, height, buttons, readOnly) {
	...
	if (buttons == true) {
		...
		document.writeln('	<tr>');
		document.writeln('		<td>');
		document.writeln('			<select class="text_field" id="formatblock_' + rte + '" onchange="Select(\'' + rte + '\', this.id);">');
		...
		document.writeln('		</td>');
		document.writeln('		<td>');
		document.writeln('			<select class="text_field" id="fontname_' + rte + '" onchange="Select(\'' + rte + '\', this.id)">');
		document.writeln('				<option value="Font" selected>[Font]</option>');
		document.writeln('				<option value="Tahoma, Verdana, sans-serif">Tahoma</option>');		
		...
		document.writeln('		</td>');
		document.writeln('		<td>');
		document.writeln('			<select class="text_field" unselectable="on" id="fontsize_' + rte + '" onchange="Select(\'' + rte + '\', this.id);">');
