...
var helpurl = 'http://' + help_domain + '/';

document.onhelp=function(){RH_ShowHelp(0,'' + helpurl + appname + '/' + accounttype + '/index.htm>Help',0,0); return false;}

/*
var contexthelpurl = helpurl + appname + '/' + accounttype + '/index.htm>Help';

function context_help(mapping)
{
	RH_ShowHelp(0,contexthelpurl,HH_HELP_CONTEXT,mapping);
}

document.write('<script src="/lib/' + appname + '/help_map.js"></script>');
