...
function createIEString(matrix, id, size, onchange, css) {
	...
	// Table Tag
		str += '<table class="selectTable" cellspacing="0" cellpadding="0" border="0" onclick="toggleDropDown(this.parentElement)">\n';
		str += '<tr>\n';
		str += '<td class="selected" height="10">&nbsp;</td>\n';
		str += '<td align="CENTER" valign="MIDDLE" class="Buttondown" onmousedown="this.style.border=\'2 inset buttonhighlight\'" onmouseup="this.style.border=\'2 outset buttonhighlight\'"><span style="position: relative; left: 0; top: -2; width: 100%;">6</span></td>\n';
		str += '</tr>\n';
		str += '</table>\n';
